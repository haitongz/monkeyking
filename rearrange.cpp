...
positive numbers they appear at the end of the array. If there are more negative numbers, they too appear in the end of
the array.
 */
void rearrange(int32_t a[], const uint32_t n) {
  // The following few lines are similar to partition process of QuickSort. The idea is to consider 0 as pivot and divide
  // the array around it.
  int32_t i = -1;
