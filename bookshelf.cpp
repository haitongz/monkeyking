/*
N cows (1 <= N <= 20) each has some height of Hi (1 <= Hi <= 1,000,000 - there are very tall cows). The bookshelf has a height of B (1 <= B <= S, where S is the sum of the heights of all cows).
