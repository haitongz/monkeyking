...
Given k be 10 the given array be a[] = {1, 2, 2, 2, 0, 2, 0, 2, 3, 8, 0, 9, 2, 3}, the maximum repeating number would be 2.
...
Iterate through all elements of input array, and for every element a[i], increment count[a[i]].
