...
autocmd FileType go set formatoptions+=ro
...
" needed, and have indentation at 2 chars to be sure that all indents are tabs
" (despite the mappings later):
autocmd FileType make set expandtab shiftwidth=2
